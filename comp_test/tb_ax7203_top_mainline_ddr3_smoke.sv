...
`ifdef TB_VERBOSE
            $display("[AX7203_MAINLINE_DDR3] LSU lsu_state=%0d m1_req_v=%0b m1_req_r=%0b m1_resp_v=%0b m1_addr=%08h m1_wr=%0b uart_busy=%0b uart_pending=%0b sb_count0=%0d sb_count1=%0d",
                     dut.u_sifang_core.u_lsu_shell.lsu_state,
                     dut.u_sifang_core.u_lsu_shell.m1_req_valid,
                     dut.u_sifang_core.u_lsu_shell.m1_req_ready,
                     dut.u_sifang_core.u_lsu_shell.m1_resp_valid,
                     dut.u_sifang_core.u_lsu_shell.m1_req_addr,
                     dut.u_sifang_core.u_lsu_shell.m1_req_write,
                     dut.u_sifang_core.gen_mem_subsys.u_mem_subsys.uart_busy,
                     dut.u_sifang_core.gen_mem_subsys.u_mem_subsys.uart_pending_valid_r,
                     dut.u_sifang_core.u_lsu_shell.u_store_buffer.sb_count,
                     0);
            $display("[AX7203_MAINLINE_DDR3] PC t0=%08h t1=%08h fetch_pc=%08h fetch_tid=%0d issue0_pc_lo=%02h issue1_pc_lo=%02h",
                     dut.u_sifang_core.u_stage_if.u_pc_mt.pc,
                     32'd0,
                     dut.u_sifang_core.u_stage_if.fetch_pc_pending,
                     0,
                     dut.u_sifang_core.debug_last_iss0_pc_lo,
                     dut.u_sifang_core.debug_last_iss1_pc_lo);
            $display("[AX7203_MAINLINE_DDR3] PIPE rstn=%0b stall=%0b sb=%0b rob=%0b fl=%0b sys=%0b if_v=%0b if_pc=%08h if_inst=%08h fb_cnt=%0d fb0=%0b fb0_pc=%08h fb0_inst=%08h dec0=%0b dec0_pc=%08h dec0_rd=%0d fu=%0d disp0=%0b disp0_g=%0b iss0=%0b iss0_pc=%08h p0ro=%0b rob_cnt=%0d head=%0d head_v=%0b head_c=%0b head_pc=%08h",
                     dut.u_sifang_core.rstn,
                     dut.u_sifang_core.stall,
                     dut.u_sifang_core.sb_disp_stall,
                     dut.u_sifang_core.rob_disp_stall,
                     dut.u_sifang_core.fl_disp_stall,
                     dut.u_sifang_core.sys_disp_stall,
                     dut.u_sifang_core.if_valid,
                     dut.u_sifang_core.if_pc,
                     dut.u_sifang_core.if_inst,
                     dut.u_sifang_core.u_fetch_buffer.count,
                     dut.u_sifang_core.fb_pop0_valid,
                     dut.u_sifang_core.fb_pop0_pc,
                     dut.u_sifang_core.fb_pop0_inst,
                     dut.u_sifang_core.dec0_valid,
                     dut.u_sifang_core.dec0_pc,
                     dut.u_sifang_core.dec0_rd,
                     dut.u_sifang_core.dec0_fu,
                     dut.u_sifang_core.disp0_accepted,
                     dut.u_sifang_core.disp0_valid_gated,
                     dut.u_sifang_core.iss0_valid,
                     dut.u_sifang_core.iss0_pc,
                     dut.u_sifang_core.p0_pre_ro_valid,
                     dut.u_sifang_core.u_rob.rob_count,
                     dut.u_sifang_core.u_rob.rob_head,
                     dut.u_sifang_core.rob_head_valid_t0,
                     dut.u_sifang_core.u_rob.rob_complete[dut.u_sifang_core.u_rob.rob_head],
                     dut.u_sifang_core.u_rob.rob_pc[dut.u_sifang_core.u_rob.rob_head]);
            $display("[AX7203_MAINLINE_DDR3] FL d0_need=%0b d1_need=%0b can1=%0b can2=%0b prd0=%0d prd1=%0d rmt0=%0b rmt1=%0b ckpt0=%0b ckpt1=%0b quar0=%0b quar1=%0b fl_head=%0d fl_tail=%0d fl_count=%0d",
                     dut.u_sifang_core.d0_needs_alloc,
                     dut.u_sifang_core.d1_needs_alloc,
                     dut.u_sifang_core.fl_can_alloc_1,
                     dut.u_sifang_core.fl_can_alloc_2,
                     dut.u_sifang_core.fl_alloc0_prd,
                     dut.u_sifang_core.fl_alloc1_prd,
                     dut.u_sifang_core.fl_alloc0_rmt_mapped,
                     dut.u_sifang_core.fl_alloc1_rmt_mapped,
                     dut.u_sifang_core.fl_alloc0_ckpt_live,
                     dut.u_sifang_core.fl_alloc1_ckpt_live,
                     dut.u_sifang_core.d0_alloc_blocked_by_branch_quarantine,
                     dut.u_sifang_core.d1_alloc_blocked_by_branch_quarantine,
                     dut.u_sifang_core.u_freelist.fl_head,
                     dut.u_sifang_core.u_freelist.fl_tail,
                     dut.u_sifang_core.u_freelist.count);
...
`endif
    ...
    always @(posedge dut.u_sifang_core.u_lsu_shell.m1_resp_valid) begin
`ifdef TB_VERBOSE
        $display("[AX7203_MAINLINE_DDR3] LSU_M1_RESP t=%0t data=%08h pending_addr=%08h pending_func3=%0d raw=%08h",
                 $time,
                 dut.u_sifang_core.u_lsu_shell.m1_resp_data,
                 dut.u_sifang_core.u_lsu_shell.pending_addr,
                 dut.u_sifang_core.u_lsu_shell.pending_func3,
                 dut.u_sifang_core.u_lsu_shell.raw_mem_rdata);
`endif
    end
