...
`ifdef TB_VERBOSE
            ...
            $display("[AX7203_MAINLINE_DDR3] PIPE rstn=%0b stall=%0b sb=%0b rob=%0b fl=%0b sys=%0b if_v=%0b if_pc=%08h if_inst=%08h fb_cnt=%0d fb0=%0b fb0_pc=%08h fb0_inst=%08h dec0=%0b dec0_pc=%08h dec0_rd=%0d fu=%0d disp0=%0b disp0_g=%0b iss0=%0b iss0_pc=%08h p0ro=%0b rob_cnt=%0d head=%0d head_v=%0b head_c=%0b head_pc=%08h",
                     dut.u_adam_riscv.rstn,
                     dut.u_adam_riscv.stall,
                     dut.u_adam_riscv.sb_disp_stall,
                     dut.u_adam_riscv.rob_disp_stall,
                     dut.u_adam_riscv.fl_disp_stall,
                     dut.u_adam_riscv.sys_disp_stall,
                     dut.u_adam_riscv.if_valid,
                     dut.u_adam_riscv.if_pc,
                     dut.u_adam_riscv.if_inst,
                     dut.u_adam_riscv.u_fetch_buffer.count,
                     dut.u_adam_riscv.fb_pop0_valid,
                     dut.u_adam_riscv.fb_pop0_pc,
                     dut.u_adam_riscv.fb_pop0_inst,
                     dut.u_adam_riscv.dec0_valid,
                     dut.u_adam_riscv.dec0_pc,
                     dut.u_adam_riscv.dec0_rd,
                     dut.u_adam_riscv.dec0_fu,
                     dut.u_adam_riscv.disp0_accepted,
                     dut.u_adam_riscv.disp0_valid_gated,
                     dut.u_adam_riscv.iss0_valid,
                     dut.u_adam_riscv.iss0_pc,
                     dut.u_adam_riscv.p0_pre_ro_valid,
                     dut.u_adam_riscv.u_rob.rob_count,
                     dut.u_adam_riscv.u_rob.rob_head,
                     dut.u_adam_riscv.rob_head_valid_t0,
                     dut.u_adam_riscv.u_rob.rob_complete[dut.u_adam_riscv.u_rob.rob_head],
                     dut.u_adam_riscv.u_rob.rob_pc[dut.u_adam_riscv.u_rob.rob_head]);
            $display("[AX7203_MAINLINE_DDR3] FL d0_need=%0b d1_need=%0b can1=%0b can2=%0b prd0=%0d prd1=%0d rmt0=%0b rmt1=%0b ckpt0=%0b ckpt1=%0b quar0=%0b quar1=%0b fl_head=%0d fl_tail=%0d fl_count=%0d",
                     dut.u_adam_riscv.d0_needs_alloc,
                     dut.u_adam_riscv.d1_needs_alloc,
                     dut.u_adam_riscv.fl_can_alloc_1,
                     dut.u_adam_riscv.fl_can_alloc_2,
                     dut.u_adam_riscv.fl_alloc0_prd,
                     dut.u_adam_riscv.fl_alloc1_prd,
                     dut.u_adam_riscv.fl_alloc0_rmt_mapped,
                     dut.u_adam_riscv.fl_alloc1_rmt_mapped,
                     dut.u_adam_riscv.fl_alloc0_ckpt_live,
                     dut.u_adam_riscv.fl_alloc1_ckpt_live,
                     dut.u_adam_riscv.d0_alloc_blocked_by_branch_quarantine,
                     dut.u_adam_riscv.d1_alloc_blocked_by_branch_quarantine,
                     dut.u_adam_riscv.u_freelist.fl_head,
                     dut.u_adam_riscv.u_freelist.fl_tail,
                     dut.u_adam_riscv.u_freelist.count);
