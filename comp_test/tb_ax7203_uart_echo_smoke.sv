...
module tb_ax7203_uart_echo_smoke;
    reg sys_clk_p;
    reg sys_clk_n;
    reg sys_rst_n;
    reg uart_rx;
    ...
    always @(posedge sys_clk_p) begin
        if (sys_rst_n &&
            ...
            $display("[AX7203_UART_ECHO] PASS ready=%0b retire=%0b tube=%0b echoed=%02h frame_count=%0d led=%b",
                     led1_ready_seen, led2_retire_seen, led3_tube_seen, echoed_byte, ext_uart_frame_count, led);
            $finish;
        end
    end
endmodule
