...
initial begin
    ...
    if (test_id == 1) begin
        ...
        pass = pass
            ...
            && (`TUBE_STATUS === 8'h04)
            && (`TB_MEM_SUBSYS.mem[1024] === 32'h00000001)
            && (`TB_MEM_SUBSYS.mem[1025] === 32'hf7f6f5f4)
            && (`TB_MEM_SUBSYS.mem[1026] === 32'hfbfaf9f8)
            && (`TB_MEM_SUBSYS.mem[1027] === 32'hfffefdfc);
    end
        ...
        pass = pass
            ...
            && (`TUBE_STATUS === 8'h04)
            && (`TB_MEM_SUBSYS.mem[1024] === 32'hf3f2f21a)
            && (`TB_MEM_SUBSYS.mem[1025] === 32'hf7f6f5f4)
            && (`TB_MEM_SUBSYS.mem[1026] === 32'hfbfaf9f8)
            && (`TB_MEM_SUBSYS.mem[1027] === 32'hfffefdfc);
    end
        ...
        pass = pass
            && (`TB_MEM_SUBSYS.mem[1152]     === 32'h00000037)  // T0 sum = 55
            && (`TB_MEM_SUBSYS.mem[1153]     === 32'h0000001E)  // T1 product = 30
        ...
        $display("DRAM[1029] BEQ  = %h, expected 0x01", `TB_MEM_SUBSYS.mem[1029]);
        $display("DRAM[1030] BNE  = %h, expected 0x02", `TB_MEM_SUBSYS.mem[1030]);
        $display("DRAM[1031] BLT  = %h, expected 0x03", `TB_MEM_SUBSYS.mem[1031]);
        $display("DRAM[1032] BGE  = %h, expected 0x04", `TB_MEM_SUBSYS.mem[1032]);
        $display("DRAM[1033] BLTU = %h, expected 0x05", `TB_MEM_SUBSYS.mem[1033]);
        $display("DRAM[1034] BGEU = %h, expected 0x06", `TB_MEM_SUBSYS.mem[1034]);
        $display("DRAM[1035] JAL  = %h, expected 0x07", `TB_MEM_SUBSYS.mem[1035]);
        $display("DRAM[1036] JALR = %h, expected 0x08", `TB_MEM_SUBSYS.mem[1036]);
        $display("DRAM[1037] LUI  = %h, expected 0xDEADB000", `TB_MEM_SUBSYS.mem[1037]);
        // Check branch-pass markers stored to DRAM by the test
        pass = pass
            && (`TUBE_STATUS   === 8'h04)        // TUBE end marker
            && (`TB_MEM_SUBSYS.mem[1029]      === 32'h00000001)  // BEQ  passed
            && (`TB_MEM_SUBSYS.mem[1030]      === 32'h00000002)  // BNE  passed
            && (`TB_MEM_SUBSYS.mem[1031]      === 32'h00000003)  // BLT  passed
            && (`TB_MEM_SUBSYS.mem[1032]      === 32'h00000004)  // BGE  passed
            && (`TB_MEM_SUBSYS.mem[1033]      === 32'h00000005)  // BLTU passed
            && (`TB_MEM_SUBSYS.mem[1034]      === 32'h00000006)  // BGEU passed
            && (`TB_MEM_SUBSYS.mem[1035]      === 32'h00000007)  // JAL  passed
            && (`TB_MEM_SUBSYS.mem[1036]      === 32'h00000008)  // JALR passed
            && (`TB_MEM_SUBSYS.mem[1037]      === 32'hDEADB000); // LUI  result
    end
